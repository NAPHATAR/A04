...
export default function TopMenuItem({ href, children }: TopMenuItemProps) {
  return (
    <Link 
      href={href} 
      className="text-gray-800 hover:text-gray-600 font-medium px-2 py-1 sm:px-3 sm:py-2 text-xs sm:text-sm lg:text-base transition-all duration-200 ease-in-out relative group"
    >
      {children}
